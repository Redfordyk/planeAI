...
| **6 — Прод и выпуск** | [BACKUP.md](BACKUP.md), [MONITORING.md](MONITORING.md), [BUDGET.md](BUDGET.md), **этот RUNBOOK.md**, [ROLLBACK.md](ROLLBACK.md), [SPRINT-6-ACCEPTANCE.md](SPRINT-6-ACCEPTANCE.md), [GDPR-RELEASE.md](GDPR-RELEASE.md), [RELEASE.md](RELEASE.md), [PHASE-2-BACKLOG.md](PHASE-2-BACKLOG.md), [RETROSPECTIVE.md](RETROSPECTIVE.md), [PROJECT-COMPLETION.md](PROJECT-COMPLETION.md) | 6.1–6.8 |
...
| Постепенный rollout релиза | [RELEASE.md](RELEASE.md) |
| Гайд по использованию для команды | [docs/user-guide.md](docs/user-guide.md) |
| Бэклог фазы 2 (что докрутить дальше) | [PHASE-2-BACKLOG.md](PHASE-2-BACKLOG.md) |
| Ретроспектива команды | [RETROSPECTIVE.md](RETROSPECTIVE.md) |
| Финальная sign-off проекта | [PROJECT-COMPLETION.md](PROJECT-COMPLETION.md) |
