          ...
          <>
            ...
            >
              <Menu.Items as={Fragment}>
                <div
                  className={cn(
                    // 22rem (was 19rem) — Russian "Пригласить участников" + "Настройки"
                    // do not fit side-by-side at 19rem.
                    "fixed z-21 mt-1 flex w-[22rem] origin-top-left flex-col divide-y divide-subtle rounded-md border-[0.5px] border-strong bg-surface-1 shadow-raised-200 outline-none",
                    {
